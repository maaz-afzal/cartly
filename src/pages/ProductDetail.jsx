      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-5">
          ...
          <div className="flex gap-4 pt-4">
            <button
              className="flex-1 bg-gray-900 dark:bg-gray-700 text-white py-3 rounded-full font-medium hover:bg-gray-800 dark:hover:bg-gray-600 transition flex items-center justify-center gap-2"
            ...
            <button
              className="p-3 border border-gray-300 dark:border-gray-600 rounded-full hover:border-red-500 dark:hover:border-red-400 hover:text-red-500 dark:hover:text-red-400 transition"
